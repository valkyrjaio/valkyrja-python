...
class ContainerInvalidArgumentException(ValkyrjaInvalidArgumentException, ContainerThrowable):
    """The base invalid argument exception of the Container component."""
